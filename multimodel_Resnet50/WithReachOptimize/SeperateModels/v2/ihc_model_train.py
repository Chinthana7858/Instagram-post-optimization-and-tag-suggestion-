...
def evaluate_model(model, dataloader):
    ...
    # Load and apply inverse transform
    ...
    r2 = r2_score(true_vals.numpy(), pred_vals.numpy())
...
if __name__ == "__main__":
    df, mlb, scaler = prepare_data(POST_CSV, MIN_TAG_COUNT, MLB_PATH)
    dataset = HashtagIHCScoreDataset(df, mlb, scaler)
    ...
    print(f"✅ Best IHC model saved to {IHC_MODEL_PATH}")
