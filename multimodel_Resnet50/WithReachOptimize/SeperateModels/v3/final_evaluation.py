...
# Load CSV
csv_path = r"E:\ProcessedV3\evaluation_output.csv"  # Replace with your file path
...
# Calculate metrics
avg_gain_percent = ((pred - prev) / prev * 100).mean()
avg_absolute_improvement = (pred - prev).mean()
avg_improvement_ratio = (pred / prev).mean()
